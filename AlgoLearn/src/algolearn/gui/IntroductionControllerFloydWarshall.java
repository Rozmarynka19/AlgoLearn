...
public class IntroductionControllerFloydWarshall extends FXMLDocumentController implements Initializable {
    ...
    public void loadText(ActionEvent event) throws IOException {
        ...
        engine.load(""+getClass().getResource("Html/floydWarshall.html"));
