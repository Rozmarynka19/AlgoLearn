...
public class DescriptionControllerBucketSort extends FXMLDocumentController implements Initializable {
    ...
    public void loadCodeExample(ActionEvent event) throws IOException {
        ...
        final String script;
        script="bucketSort_"+selectedLangButton+"()";
        engine = descriptionText.getEngine();
        engine.setJavaScriptEnabled(true);
        engine.load(""+getClass().getResource("Html/bucketSortCodes.html"));
