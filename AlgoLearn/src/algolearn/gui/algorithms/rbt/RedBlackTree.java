...
import algolearn.gui.FXMLDocumentController_RBT;
...
public class RedBlackTree<E extends Comparable<E>> extends BST<E> {
	...
	FXMLDocumentController_RBT rbtController = null;

    public RedBlackTree() {
    }
    
    public RedBlackTree(FXMLDocumentController_RBT rbtContr) {
    	 rbtController=rbtContr;
    }
