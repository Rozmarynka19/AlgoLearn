...
public class DescriptionControllerUFKruskal extends FXMLDocumentController implements Initializable {
    ...
    public void loadCodeExample(ActionEvent event) throws IOException {
        ...
        else if(clicked_btn.getText().equals("Klasy pomocnicze")){
        	script="helpClasses_"+selectedLangButton+"()";
        }
        else {
        	script="union_"+selectedLangButton+"()";
        }
        engine = descriptionText.getEngine();
